...
import { useSettings } from '@/context/SettingsContext' // 1. Importamos el hook
...
export default function CarDetailPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const { contact } = useSettings() // 2. Obtenemos el contacto sincronizado
                        ...
                        <div className="sticky top-32 space-y-4">
                            ...
                            <div className="bg-[#FBFBFB] rounded-2xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <div className="text-center">
                                    ...
                                    <a
                                        href={`https://wa.me/${contact.whatsapp || "569XXXXXXXX"}?text=${encodeURIComponent(`Hola, me interesa el ${car.make} ${car.model} (${car.year}) que vi en el catálogo.`)}`}
                                        target="_blank"
