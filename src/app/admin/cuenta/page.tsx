    ...
    return (
        <div className="min-h-screen bg-[#F7F8FA] text-black font-sans antialiased pb-40 text-left no-scrollbar">
            <style jsx global>{`
                ...
                body { overflow: hidden !important; scrollbar-width: none !important; }
                .main-scroll { height: 100vh; overflow-y: auto; scrollbar-width: none; }
            `}</style>

            <div className="main-scroll no-scrollbar">

                {/* NAV CENTRALIZADO - Pasando el nombre para que diga vdl o Matias */}
                ...
                <main className="max-w-7xl mx-auto px-6 py-8">
                    <header className="flex justify-between items-end mb-9 gap-4 relative">
                        ...
                        <button onClick={handleSave} disabled={isSubmitting} className="bg-black text-white text-[9px] font-black uppercase tracking-[0.2em] px-10 py-3 rounded-xl shadow-xl shadow-black/10 transition-all">
                        ...
                        <div className="space-y-8">
                            <div className="bg-white rounded-[30px] border border-gray-100 p-8 text-center">
                                ...
                                <div className="relative inline-block">
                                    ...
                                    <button onClick={() => fileInputRef.current?.click()} className="absolute bottom-0 right-0 bg-black text-white w-10 h-10 rounded-full flex items-center justify-center border-4 border-white shadow-lg">
                                ...
                                <div className="mt-8">
                                    ...
                                    <p className="text-[9px] font-bold text-zinc-400 uppercase tracking-tighter mt-1 italic">{profileData.role}</p>
                                </div>
                            </div>
