...
export default function LoginPage() {
    ...
    return (
        <div className="fixed inset-0 min-h-screen flex antialiased font-sans z-[100] bg-white">
            ...
            {/* LADO IZQUIERDO: NEGRO SÓLIDO (60%) - OCULTO EN MÓVIL */}
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                required
                                className={`w-full bg-[#F7F7F7] border ${error ? 'border-red-500' : 'border-gray-200'} px-4 py-3 rounded-xl text-[11px] font-black text-zinc-600 focus:outline-none focus:border-black transition-colors placeholder:text-zinc-400 placeholder:normal-case`}
                            />
                            {error && (
                                <p className="text-[9px] text-red-500 font-black uppercase tracking-widest ml-1 animate-pulse italic mt-2 text-left">
