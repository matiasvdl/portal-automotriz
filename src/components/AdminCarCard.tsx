function AdminCarCard({ car }: { car: any }) {
    ...
    return (
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden flex flex-col h-full hover:shadow-2xl transition-all hover:shadow-black/[0.05]">
            ...
            <div className="p-5 flex-grow flex flex-col justify-between space-y-4 text-left">
                <div>
                    ...
                    {/* SPECS: Sin justify-between para que no se separen */}
                ...
                <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <div className="w-9 h-9 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 shrink-0 transition-colors group-hover:bg-black group-hover:text-white group-hover:border-black">
